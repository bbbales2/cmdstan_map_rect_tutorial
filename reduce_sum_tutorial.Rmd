...
it is recommended to use 2 threads per chain and sample the chains in
parallel. This is commonly best whenever all chains will sample about
the same amount of time, which is most often the case. The
within-chain parallelism is generally less effiecient as compared to
running chains in parallel. So if greater speedups are desired, then
the user can choose to run fewer chains (i.e. 2 chains with 4 threads
